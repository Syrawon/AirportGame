...
public class PlanePath {
	...
	// Avance de "amount" pixels le long du chemin "path" ou, s'il n'est pas spécifié, dans la direction spécifiée par "angle".
		...
		for (i=index; i < size; i++) {
			...
			if (totalDistance > amount) {
				...
				location.setLocation(
					lastPoint.getX() + (point.getX() - lastPoint.getX()) * progress,
