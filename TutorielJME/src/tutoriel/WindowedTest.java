...
public class WindowedTest {
	...
	private static CubesTest cubeApp;
	...
	public static void main(String[] args){
		...
		// in the same way than in the "public static void main()" method from SimpleApplication
		 ...
		 cubeApp.setSettings(settings);
		 cubeApp.setShowSettings(false);
		 settings.setFrameRate(60);
		 settings.setVSync(true);
		 cubeApp.setDisplayStatView(false);
